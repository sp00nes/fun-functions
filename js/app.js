...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let totalProduct = multiply(a, b)[0];
  totalProduct = multiply(totalProduct, c)[0];
  //console.log (totalProduct);
  let messageSum = `${a} and ${b} and ${c} sum to ${totalSum}.`;
  //console.log (messageSum);
  let messageProduct = `The product of ${a} and ${b} and ${c} is ${totalProduct}.`;
  //console.log (messageProduct);
  return [totalSum, totalProduct, messageSum, messageProduct];
}

// Here is the tesmessageProductt for sumAndMultiply(); uncomment it to run it
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let message = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${totalProduct}.`;
  //console.log(message);
  return [totalProduct, message];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  let answer = multiplyArray(dynamicArray)[0];
  let message = `The numbers 1,2,3,4,5 have a product of ${answer}.`;
